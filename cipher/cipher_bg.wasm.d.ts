...
export const derive_my_alias: (a: number, b: number, c: number, d: number) => [number, number, number, number];
export const derive_their_alias: (a: number, b: number, c: number, d: number) => [number, number, number, number];
