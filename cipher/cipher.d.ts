 ...
 */
export function derive_my_alias(private_key_hex: string, their_address_string: string): string;
/**
 * Alias used when sending messages to this peer.
 * Matches KaChat's DeterministicAlias.deriveTheirAlias.
 */
export function derive_their_alias(private_key_hex: string, their_address_string: string): string;
...
export interface InitOutput {
  ...
  readonly derive_my_alias: (a: number, b: number, c: number, d: number) => [number, number, number, number];
  readonly derive_their_alias: (a: number, b: number, c: number, d: number) => [number, number, number, number];
